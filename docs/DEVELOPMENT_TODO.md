...
2. **CLIProxyAPI Extension** - 作为默认内置扩展 MVP 实现：backend 支持 lifecycle 端点，Extensions UI 支持 missing/installed 状态、`~/.uuagent/plugins/cliproxyapi/cli-proxy-api.exe` 路径提示、Start/Stop/Restart 控制与查看 logs/status。
